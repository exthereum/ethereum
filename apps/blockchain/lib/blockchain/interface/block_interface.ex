defmodule Blockchain.Interface.BlockInterface do
  ...
  ## Examples
      ...
      iex> block_header = %EVM.Block.Header{}
...
defimpl EVM.Interface.BlockInterface, for: Blockchain.Interface.BlockInterface do
  ...
  ## Examples
      ...
      iex> Blockchain.Interface.BlockInterface.new(%EVM.Block.Header{number: 10}, nil)
      ...> |> EVM.Interface.BlockInterface.get_block_header()
      %EVM.Block.Header{number: 10}
  """
  ...
  ## Examples
      ...
      iex> Blockchain.Interface.BlockInterface.new(%EVM.Block.Header{}, db)
      ...> |> EVM.Interface.BlockInterface.get_block_by_hash(block_hash)
      %EVM.Block.Header{number: 5, parent_hash: <<1, 2, 3>>, beneficiary: <<2, 3, 4>>, difficulty: 100, timestamp: 11, mix_hash: <<1>>, nonce: <<2>>}
  """
  ...
  def get_block_by_number(block_interface, steps) do
    case Block.get_block_hash_by_steps(
           block_interface.block_header |> Header.hash(),
           steps,
           block_interface.db
         ) do
