defmodule Blockchain.Transaction do
  ...
  ## Examples
      ...
      ...> |> Blockchain.Transaction.is_valid?(trx, %EVM.Block.Header{})
      ...
      ...> |> Blockchain.Transaction.is_valid?(trx, %EVM.Block.Header{gas_limit: 50_000, gas_used: 49_999})
      ...
      iex> MerklePatriciaTree.Trie.new(MerklePatriciaTree.Test.random_ets_db())
      ...> |> Blockchain.Account.put_account(sender, %Blockchain.Account{balance: 100_006, nonce: 5})
      ...> |> Blockchain.Transaction.is_valid?(trx, %EVM.Block.Header{gas_limit: 500_000, gas_used: 49_999})
      :valid
  """
  ...
  ## Examples
      ...
      ...> |> Blockchain.Transaction.execute_transaction(trx, %EVM.Block.Header{beneficiary: beneficiary})
      iex> {gas, logs}
      {53780, []}
  ...
  ## Examples
      ...
      iex> Blockchain.Transaction.finalize_transaction_gas(state, <<0x01::160>>, trx, 5, %EVM.Block.Header{beneficiary: <<0x02::160>>})
  ...
  ## Examples
      ...
      iex> Blockchain.Transaction.intrinsic_gas_cost(%Blockchain.Transaction{to: <<1::160>>, init: <<>>, data: <<1, 2, 0, 3>>}, %EVM.Block.Header{number: 5})
      3 * 68 + 4 + 21000

      iex> Blockchain.Transaction.intrinsic_gas_cost(%Blockchain.Transaction{to: <<1::160>>, init: <<>>, data: <<1, 2, 0, 3>>}, %EVM.Block.Header{number: 5_000_000})
      3 * 68 + 4 + 21000

      iex> Blockchain.Transaction.intrinsic_gas_cost(%Blockchain.Transaction{to: <<1::160>>, init: <<>>, data: <<>>}, %EVM.Block.Header{number: 5_000_000})
      21000

      iex> Blockchain.Transaction.intrinsic_gas_cost(%Blockchain.Transaction{to: <<>>, init: <<1, 2, 0, 3>>, data: <<>>}, %EVM.Block.Header{number: 5})
      3 * 68 + 4 + 21000
