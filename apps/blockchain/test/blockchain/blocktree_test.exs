defmodule Blockchain.BlocktreeTest do
  ...
  test "multi-level tree" do
    ...
    block_20 = %Blockchain.Block{
      block_hash: <<20>>,
      header: %Header{number: 1, parent_hash: <<10>>, difficulty: 110}
    }

    block_21 = %Blockchain.Block{
      block_hash: <<21>>,
      header: %Header{number: 1, parent_hash: <<10>>, difficulty: 120}
    }

    block_30 = %Blockchain.Block{
      block_hash: <<30>>,
      header: %Header{number: 2, parent_hash: <<20>>, difficulty: 120}
    }

    block_40 = %Blockchain.Block{
      block_hash: <<40>>,
      header: %Header{number: 3, parent_hash: <<30>>, difficulty: 120}
    }
