defmodule EVM.Operation.BlockInformation do
  ...
  ## Examples
      ...
      iex> block_b = %EVM.Block.Header{number: 2, mix_hash: "block_b"}
      iex> block_a = %EVM.Block.Header{number: 1, mix_hash: "block_a"}
      iex> genesis_block = %EVM.Block.Header{number: 0, mix_hash: <<0x00::256>>}
  ...
  ## Examples
      ...
      iex> block_interface = EVM.Interface.Mock.MockBlockInterface.new(%EVM.Block.Header{beneficiary: <<0x55::160>>})
      iex> exec_env = %EVM.ExecEnv{block_interface: block_interface}
  ...
  ## Examples
      ...
      iex> block_interface = EVM.Interface.Mock.MockBlockInterface.new(%EVM.Block.Header{timestamp: 1_000_000})
      iex> exec_env = %EVM.ExecEnv{block_interface: block_interface}
  ...
  ## Examples
      ...
      iex> block_interface = EVM.Interface.Mock.MockBlockInterface.new(%EVM.Block.Header{number: 1_500_000})
      iex> exec_env = %EVM.ExecEnv{block_interface: block_interface}
  ...
  ## Examples
      ...
      iex> block_interface = EVM.Interface.Mock.MockBlockInterface.new(%EVM.Block.Header{difficulty: 2_000_000})
      iex> exec_env = %EVM.ExecEnv{block_interface: block_interface}
  ...
  ## Examples
      ...
      iex> block_interface = EVM.Interface.Mock.MockBlockInterface.new(%EVM.Block.Header{gas_limit: 3_000_000})
      iex> exec_env = %EVM.ExecEnv{block_interface: block_interface}
