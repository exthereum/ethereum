defmodule ExWire.Framing.FrameTest do
  ...
  test "mac encoder" do
    ...
    input_1 = "12532abaec065082a3cf1da7d0136f15" |> Math.hex_to_bin()
    input_2 = "7e99f682356fdfbc6b67a9562787b18a" |> Math.hex_to_bin()
  ...
  test "simple frame test read / write" do
    ...
    symmetric_key = Keccak.kec(<<>>)
    mac_secret = Keccak.kec(<<>>)
