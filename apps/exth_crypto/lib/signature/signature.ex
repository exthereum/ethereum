defmodule ExthCrypto.Signature do
  ...
  """
  @spec get_public_key(Key.private_key()) :: {:ok, Key.public_key()} | {:error, String.t()}
  ...
  ## Examples
      ...
      true
  """
  @spec sign_digest(binary(), Key.private_key()) :: {signature, r, s, recovery_id}
  ...
  ## Examples
      ...
      false
  """
  @spec verify(binary(), signature, Key.public_key()) :: boolean()
  ...
  @spec recover(binary(), signature, recovery_id) ::
          {:ok, Key.public_key()} | {:error, String.t()}
